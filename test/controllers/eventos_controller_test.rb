...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { data: @evento.data, evento: @evento.evento, horario: @evento.horario } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { data: @evento.data, evento: @evento.evento, horario: @evento.horario } }
