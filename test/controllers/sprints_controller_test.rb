...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post sprints_url, params: { sprint: { check: @sprint.check, project_id: @sprint.project_id, tarefa: @sprint.tarefa } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { check: @sprint.check, project_id: @sprint.project_id, tarefa: @sprint.tarefa } }
