...
class ProjectsUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projects_user" do
    assert_difference('ProjectsUser.count') do
      post projects_users_url, params: { projects_user: { : @projects_user., : @projects_user., : @projects_user., : @projects_user. } }
    end
  ...
  test "should update projects_user" do
    patch projects_user_url(@projects_user), params: { projects_user: { : @projects_user., : @projects_user., : @projects_user., : @projects_user. } }
