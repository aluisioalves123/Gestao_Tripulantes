...
class CashiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cashier" do
    assert_difference('Cashier.count') do
      post cashiers_url, params: { cashier: { categoria: @cashier.categoria, data: @cashier.data, nome: @cashier.nome, valor: @cashier.valor } }
    end
  ...
  test "should update cashier" do
    patch cashier_url(@cashier), params: { cashier: { categoria: @cashier.categoria, data: @cashier.data, nome: @cashier.nome, valor: @cashier.valor } }
